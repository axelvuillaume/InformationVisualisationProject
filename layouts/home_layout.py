...
from utils.load_data import cleaned_games, categories, genres, current_user_games, update_user_data, supported_languages, full_audio_languages
...
def generate_home_layout():
    return html.Div(
        ...
        children=[
            ...
            html.Div(id="_"), #dummy for user update output
            html.Div([
                "Steam Id: ",
